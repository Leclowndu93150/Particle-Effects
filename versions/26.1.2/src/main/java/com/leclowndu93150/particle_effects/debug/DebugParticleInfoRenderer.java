package com.leclowndu93150.particle_effects.debug;

import com.leclowndu93150.particle_effects.config.ParticleEffectsConfig;
import com.leclowndu93150.particle_effects.mixin.ParticleEngineMixin;
import com.leclowndu93150.particle_effects.particle.TexturedParticle;
...
public class DebugParticleInfoRenderer {
	...
	private static String[] getDebugInfo(Particle particle) {
		int color;
		int alpha;
		int red;
		int green;
